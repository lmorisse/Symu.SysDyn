...
{
    /// <summary>
    /// Implementation of https://github.com/SDXorg/test-models/tree/master/tests/macro_stock
    /// </summary>

    [TestClass]
    public class MacroStock : FunctionClassTest
    {
        [TestInitialize]
        public async Task InitializeTest()
        {
            await Initialize("MacroStock.xmile");
        }
