...
namespace SymuSysDynTests.Functions
{
    ...
    public class Smth1SuiteTests
    {
        ...
        [TestMethod()]
        public void Smth1SuiteTest()
        {
            var smth = new Smth1Suite("SMTH1Suite(5+Step(10,3),5)");
        ...
        [TestMethod()]
        public void Smth1SuiteTest1()
        {
            var smth = new Smth1Suite("SMTH1Suite(5+Step(10,3),5,2)");
        ...
        {
            var smth = new Smth1Suite("SMTH1Suite(5+Step(10,3),5,5)");
        ...
        public void EvaluateTest2()
        {
            ...
            var aux1 = new Auxiliary("aux1", "SMTH1Suite(aux, 5)");
